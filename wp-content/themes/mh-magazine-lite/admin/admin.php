		...
		<div class="theme-info-wrap">
			...
			<div class="theme-links clearfix">
				<p>
					...
					<a href="<?php echo esc_url('http://www.mhthemes.com/themes/mh/magazine-lite/?utm_source=WP&utm_medium=Textlink&utm_content=Admin&utm_campaign=Magazine'); ?>" target="_blank">
						<?php esc_html_e('Theme Info Page', 'mh-magazine-lite'); ?>
					</a>
					<a href="<?php echo esc_url('http://www.mhthemes.com/support/?utm_source=WP&utm_medium=Textlink&utm_content=Admin&utm_campaign=Magazine'); ?>" target="_blank">
				...
				<div class="mh-row clearfix">
					<div class="mh-col-1-2">
						<div class="section">
							...
							<p>
								<a href="<?php echo esc_url('http://www.mhthemes.com/support/documentation-mh-magazine/?utm_source=WP&utm_medium=Button&utm_content=Admin&utm_campaign=Magazine'); ?>" target="_blank" class="button button-secondary">
						...
						<div class="section">
							...
							<p>
								<a href="<?php echo esc_url('http://www.mhthemes.com/themes/mh/magazine/?utm_source=WP&utm_medium=Button&utm_content=Admin&utm_campaign=Magazine'); ?>" target="_blank" class="button button-secondary">
			...
			<div id="theme-author">
				<p>
					<?php printf(esc_html__('%1s is proudly brought to you by %2s. If you like %3s: %4s.', 'mh-magazine-lite'), $theme_data->Name, '<a target="_blank" href="http://www.mhthemes.com/?utm_source=WP&utm_medium=Textlink&utm_content=Admin&utm_campaign=Magazine" title="MH Themes">MH Themes</a>', $theme_data->Name, '<a target="_blank" href="https://wordpress.org/support/view/theme-reviews/mh-magazine-lite?filter=5" title="MH Magazine lite Review">' . esc_html__('Rate this theme', 'mh-magazine-lite') . '</a>'); ?>
				</p>
			</div>
		</div><?php
	}
