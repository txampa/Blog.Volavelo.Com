	...
	class MH_Magazine_Lite_Upgrade extends WP_Customize_Control {
        public function render_content() {  ?>
			...
			<p class="mh-upgrade-button">
				<a href="http://www.mhthemes.com/themes/mh/magazine/?utm_source=Customizer&utm_medium=Button&utm_content=Panel&utm_campaign=Magazine" target="_blank" class="button button-secondary">
...
function mh_magazine_lite_customizer_js() {
	...
	wp_localize_script('mh-customizer', 'mh_magazine_lite_links', array(
		'upgradeURL' => esc_url('http://www.mhthemes.com/themes/mh/magazine/?utm_source=Customizer&utm_medium=Button&utm_content=Button&utm_campaign=Magazine'),
		'upgradeLabel' => esc_html__('Upgrade to MH Magazine Pro', 'mh-magazine-lite'),
		'title'	=> esc_html__('Theme Related Links:', 'mh-magazine-lite'),
		'themeURL' => esc_url('http://www.mhthemes.com/themes/mh/magazine-lite/?utm_source=Customizer&utm_medium=Textlink&utm_content=Panel&utm_campaign=Magazine'),
		'themeLabel' => esc_html__('Theme Info Page', 'mh-magazine-lite'),
		'docsURL' => esc_url('http://www.mhthemes.com/support/documentation-mh-magazine/?utm_source=Customizer&utm_medium=Textlink&utm_content=Panel&utm_campaign=Magazine'),
